-- QtUiPlus :: modules/merchant.lua
--
-- pfUI-modern-inspired treatment of the native Merchant window. Native item
-- data, buy/sell/repair logic and tab switching stay intact; QtUiPlus changes
...
local function TintRow(owner)
  if not owner or owner.qtpRowTint then return end
...
-- evidence -- no query_compat.py or query_QtUiPlus.py record covers either
...
local function BuildFrame()
  ...
  -- keeps QtUiPlus's border/icon framing in sync with it. StyleStockButton
