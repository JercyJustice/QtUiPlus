-- QtUiPlus :: modules/spellbook.lua
--
...
local function StyleSpellButton(index, refreshOnly)
  ...
  if highlight and not highlight.qtpSpellHighlightSuppressed then
    U.HideRegion(highlight)
    pcall(function()
      highlight.qtpSpellHighlightSuppressed = true
