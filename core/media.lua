...
-- reload. QtUiPlus persists short media *ids* only (see core/config.lua) and
...
-- OUTLINE read back as GameFontNormal / 12 / NONE. QtUiPlus therefore ships no
...
-- panel look without shipping binary media, and keeps QtUiPlus off the
...
-- QtUiPlus accent: panel headings, the active item in the settings list,
-- checkbox fills, slider thumbs and the edit-mode handles. Bar fills and unit
-- colours stay as they are -- the accent marks QtUiPlus's own chrome, not game
-- state.
M.color = {
  ...
  -- accent: it is a shade over game content, not QtUiPlus chrome, and it has to
