...
-- repositioned by the user, independent of QtUiPlus's edit/mover mode.
--
...
function U.MakeWindowDraggable(id, frame, options)
  ...
  local handle = CreateFrame("Button", "QtUiPlusWindowDrag" .. dragCount, frame)
